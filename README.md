...
We're using [`react-static`](https://github.com/react-static/react-static) for this demo because it is a static site generator. This is significant because, as a general rule, many platforms that support sharing, do not crawl dynamically generated meta tags. By this we mean, tags generated by JavaScript at runtime.

Rather, these tags must be baked into the HTML that is served up. One way to tackle this is through dynamically serving up the meta tags from the server [as this post illustrates](https://blog.logrocket.com/adding-dynamic-meta-tags-react-app-without-ssr/).  Another way is by ensuring that tags are in the built HTML in the first place. This is exactly what a static site generator like `react-static` does.
